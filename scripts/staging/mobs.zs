...
import scripts.staging.stages.stageArchery;
import scripts.staging.stages.stagePrehistoric;

armoreablemobs as scripts.classes.mods.armoreablemobs.ArmoreableMobs = scripts.classes.mods.armoreablemobs.ArmoreableMobs();
...
function addstageZeroMobArmor() {
	var stageName as string = stagePrehistoric.stage;
...
function addArcheryMobArmor() {
	var stageName as string = stageArchery.stage;
...
function addStageTwoMobArmor() {
	var stageName as string = stageMedieval.stage;
...
function addStageFiveMobArmor() {
	var stageName as string = stageIndustrial.stage;
