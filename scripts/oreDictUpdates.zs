...
<ore:logJungle>.add(<twilightforest:twilight_log:1>);
<ore:logJungle>.add(<biomesoplenty:log_3:5>);
<ore:logJungle>.add(<forestry:logs.0:1>);
<ore:logJungle>.add(<forestry:logs.2>);
<ore:logJungle>.add(<forestry:logs.2:2>);
<ore:logJungle>.add(<forestry:logs.3:2>);
<ore:logJungle>.add(<forestry:logs.4:3>);
<ore:logJungle>.add(<forestry:logs.7>);
<ore:logJungle>.add(<forestry:logs.6:3>);
<ore:logJungle>.add(<forestry:logs.6:2>);

<ore:logDarkOak>.add(<twilightforest:twilight_log:3>);
<ore:logDarkOak>.add(<thaumcraft:log_greatwood>);
<ore:logDarkOak>.add(<rustic:log:1>);
<ore:logDarkOak>.add(<biomesoplenty:log_3:6>);
<ore:logDarkOak>.add(<forestry:logs.1:1>);

<ore:logOak>.add(<forestry:logs.4>);
<ore:logOak>.add(<forestry:logs.3:3>);
<ore:logOak>.add(<forestry:logs.3:1>);
<ore:logOak>.add(<forestry:logs.1>);
<ore:logOak>.add(<twilightforest:twilight_log>);
<ore:logOak>.add(<rustic:log>);
<ore:logOak>.add(<biomesoplenty:log_0:4>);
<ore:logOak>.add(<biomesoplenty:log_2:7>);
<ore:logOak>.add(<biomesoplenty:log_3:4>);
<ore:logOak>.add(<forestry:logs.5:1>);
<ore:logOak>.add(<forestry:logs.5:2>);
<ore:logOak>.add(<forestry:logs.5:3>);
<ore:logOak>.add(<minecraft:log>);

<ore:logAcacia>.add(<forestry:logs.2:2>);
<ore:logAcacia>.add(<forestry:logs.7>);
<ore:logAcacia>.add(<forestry:logs.6:1>);
<ore:logAcacia>.add(<forestry:logs.6:2>);
<ore:logAcacia>.add(<forestry:logs.1:2>);
<ore:logAcacia>.add(<forestry:logs.0:1>);

<ore:logBirch>.add(<twilightforest:magic_log:1>);
<ore:logBirch>.add(<twilightforest:magic_log:2>);
<ore:logBirch>.add(<forestry:logs.3>);
<ore:logBirch>.add(<forestry:logs.2:3>);
<ore:logBirch>.add(<betterwithmods:blood_log>);
<ore:logBirch>.add(<biomesoplenty:log_1:6>);
<ore:logBirch>.add(<harvestcraft:pampaperbark>);
<ore:logBirch>.add(<thaumcraft:log_silverwood>);
<ore:logBirch>.add(<twilightforest:twilight_log:2>);
<ore:logBirch>.add(<bewitchment:elder_wood>);

<ore:logSpruce>.add(<primal:logs:1>);
<ore:logSpruce>.add(<biomesoplenty:log_0:7>);
<ore:logSpruce>.add(<biomesoplenty:log_2:4>);
<ore:logSpruce>.add(<biomesoplenty:log_2:6>);
<ore:logSpruce>.add(<forestry:logs.0:0>);
<ore:logSpruce>.add(<forestry:logs.1:3>);
<ore:logSpruce>.add(<forestry:logs.4:1>);
<ore:logSpruce>.add(<forestry:logs.5>);
<ore:logSpruce>.add(<totemic:cedar_log>);
...
<ore:seed>.add(<agricraft:agri_seed>);
<ore:seed>.add(<agricraft:agri_seed>);
<ore:seed>.add(<agricraft:agri_seed>);
<ore:seed>.add(<agricraft:agri_seed>);
<ore:seed>.add(<agricraft:agri_seed>);
...
<ore:seed>.add(<agricraft:agri_seed>);
<ore:seed>.add(<agricraft:agri_seed>);
<ore:seed>.add(<roots:moonglow_seed>);
<ore:seed>.add(<roots:spirit_herb_seed>);
<ore:seed>.add(<roots:wildewheet_seed>);
...
<ore:seed>.add(<t3s4ebw:magic_seed>);
<ore:seed>.add(<agricraft:agri_seed>);
<ore:seed>.add(<agricraft:agri_seed>);
<ore:seed>.add(<agricraft:agri_seed>);
<ore:seed>.add(<agricraft:agri_seed>);
...
<ore:seed>.add(<agricraft:agri_seed>);
<ore:seed>.add(<agricraft:agri_seed>);
<ore:seed>.add(<rustic:ironwoodseed>);
<ore:seed>.add(<rusticthaumaturgy:cindermote_seeds>);

<ore:listAllfruit>.add(<harvestcraft:cactusfruititem>);
<ore:listAllfruit>.add(<harvestcraft:cantaloupeitem>);
<ore:listAllfruit>.add(<harvestcraft:pineappleitem>);
<ore:listAllfruit>.add(<harvestcraft:passionfruititem>);
<ore:listAllfruit>.add(<harvestcraft:figitem>);
<ore:listAllfruit>.add(<harvestcraft:apricotitem>);
<ore:listAllfruit>.add(<harvestcraft:durianitem>);
<ore:listAllfruit>.add(<harvestcraft:coconutitem>);
<ore:listAllfruit>.add(<harvestcraft:durianitem>);
<ore:listAllfruit>.add(<harvestcraft:lycheeitem>);
<ore:listAllfruit>.add(<harvestcraft:persimmonitem>);
<ore:listAllfruit>.add(<harvestcraft:plumitem>);
<ore:listAllfruit>.add(<harvestcraft:bananaitem>);
<ore:listAllfruit>.add(<harvestcraft:mangoitem>);
<ore:listAllfruit>.add(<harvestcraft:orangeitem>);
<ore:listAllfruit>.add(<harvestcraft:dragonfruititem>);
<ore:listAllfruit>.add(<biomesoplenty:pear>);
<ore:listAllfruit>.add(<biomesoplenty:peach>);
<ore:listAllfruit>.add(<biomesoplenty:persimmon>);
<ore:listAllfruit>.add(<minecraft:apple>);
<ore:listAllfruit>.remove(<forestry:fruits:2>);